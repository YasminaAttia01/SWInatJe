    ...
    <>
      <div className="relative flex w-full flex-col lg:flex-row lg:items-center lg:justify-between items-center justify-center gap-20 px-32 py-40 ">
        ...
        <div className="flex flex-col lg:items-center justify-center gap-8 z-10 mt-[20rem] mb-1 items-center w-full mt-20 lg:mt-10 py-20 ">
          <h1 className="text-white text-yellow-500 font-extrabold text-5xl lg:text-5xl text-center underline">
            Cultures hors sol
          </h1>
      ...
      <div className="z-10 w-full text-center p-10 bg-white">
        <div className="flex items-center justify-center py-4 gap-7">
          ...
          <h2 className="text-3xl font-bold underline" style={{ fontFamily: 'Typo Grotesk', color:'#DAA520' }}>Système Hydroponique</h2>
          <div className="w-1/4 bg-yellow-500 h-0.5"></div>
        </div>
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-10 mt-6 px-10">
          <Image src="/images/service1.jpg" alt="Système hydroponique table" layout="intrinsic" width={150} height={100} className="rounded-lg"/>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex flex-col items-center">
            <Image src="/images/service1.jpg" alt="Système hydroponique table" layout="responsive" width={150} height={100} className="rounded-lg"/>
            <h3 className="font-semibold mt-2" style={{ color:'#DAA520' }}>Système hydroponique table</h3>
          </div>
          <div className="flex flex-col items-center">
            <Image src="/images/pres11.png" alt="Système hydroponique étagère" layout="responsive" width={150} height={100} className="rounded-lg"/>
      ...
      <div className="z-10 w-full text-center p-10 bg-yellow-50">
        <div className="flex items-center justify-center py-4 gap-7">
          <div className="w-1/4 bg-yellow-500 h-0.5"></div>
          <h2 className="text-3xl font-bold underline" style={{ fontFamily: 'Typo Grotesk', color:'#DAA520' }}>Mur végétal</h2>
          <div className="w-1/4 bg-yellow-500 h-0.5"></div>
        </div>
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-10 mt-6 px-10">
          <Image src="/images/pres22.png" alt="Mur végétal" layout="intrinsic" width={150} height={100} className="rounded-lg"/>
          <p className="text-gray-600 text-left">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex flex-col items-center">
            <Image src="/images/pres22.png" alt="Mur végétal intérieur" layout="responsive" width={150} height={100} className="rounded-lg"/>
          </div>
          <div className="flex flex-col items-center">
            <Image src="/images/pres222.png" alt="Mur végétal extérieur" layout="responsive" width={150} height={100} className="rounded-lg"/>
          </div>
        </div>
      </div>
      ...
      <div className="z-10 w-full text-center p-10 bg-white">
        <div className="flex items-center justify-center py-4 gap-7">
          <div className="w-1/4 bg-yellow-500 h-0.5"></div>
          <h2 className="text-3xl font-bold underline" style={{ fontFamily: 'Typo Grotesk', color:'#DAA520' }}>Bac à potager</h2>
          <div className="w-1/4 bg-yellow-500 h-0.5"></div>
        </div>
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-10 mt-6 px-10">
          <Image src="/images/pres33.png" alt="Bac à potager à fond" layout="intrinsic" width={150} height={100} className="rounded-lg"/>
          <p className="text-gray-600 text-left">
            C’est une structure réceptacle spécifiquement conçue pour la culture de plantes comestibles, adaptée aux espaces restreints ou urbains. Ce récipient, généralement rectangulaire et souvent en bois, en plastique ou en métal, contient un substrat de culture dans lequel les plantes sont cultivées :
          </p>
        </div>
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex flex-col items-center">
            <Image src="/images/pres33.png" alt="Bac à potager à fond" layout="responsive" width={150} height={100} className="rounded-lg"/>
            <h3 className="font-semibold mt-2" style={{ color:'#DAA520' }}>Bac à potager à fond</h3>
          </div>
          <div className="flex flex-col items-center">
            <Image src="/images/pres333.png" alt="Bac à potager à support" layout="responsive" width={150} height={100} className="rounded-lg"/>
